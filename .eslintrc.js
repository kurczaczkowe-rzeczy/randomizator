module.exports = {
  ...
  rules: {
    ...
    'no-empty-function': 'off', // remove line after removing last occurrence of () => {}
    '@typescript-eslint/no-empty-function': 'off', // remove line after removing last occurrence of () => {}
    'no-empty-pattern': [ 2 ],
    'no-ex-assign': [ 2 ],
